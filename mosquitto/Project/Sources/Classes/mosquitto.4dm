...
Class constructor($command : Text; $controller : 4D:C1709.Class)
	...
	Super:C1705($command; $controller=Null:C1517 ? cs:C1710._mosquitto_Controller : $controller)
...
Function get controller : cs:C1710._mosquitto_Controller
...
Function parseOptions($options : Object)->$command : Text
	...
	If ($options#Null:C1517)
		...
		var $secure : Boolean
		$secure:=($options.cafile#Null:C1517) && (OB Instance of:C1731($options.cafile; 4D:C1709.File)) && ($options.cafile.exists)
		...
		Else 
			This:C1470.port:=$secure ? 1883 : 8883
		End if 
		
		If ($options.qos#Null:C1517)
			This:C1470.qos:=Num:C11($options.qos)
			$command+=" -q"
			$command+=" "+This:C1470.escape(String:C10(This:C1470.qos))
		Else 
			This:C1470.qos:=0
		End if 
